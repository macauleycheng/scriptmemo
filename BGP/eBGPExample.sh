...
neighbor 192.168.50.2 remote-as 2000
...
neighbor 192.168.60.1 remote-as 3000
address-family ipv4 unicast
network 192.168.20.0/24
end

#frr3
sudo docker exec -it frr3 bash
...
no bgp ebgp-requires-policy
neighbor 192.168.60.2 remote-as 2000
address-family ipv4 unicast
